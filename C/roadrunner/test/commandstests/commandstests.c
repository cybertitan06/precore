...
{
    char *test_name = "deserialize_command(): should_deserialize_good_stream";
    // start the test
...
{
    char *test_name = "deserialize_command(): should_deserialize_null_byte_cmd_args";
    // start the test
    TEST_START(test_name);
    // initialize required variables for testing
    Command *cmd_struct;
...
{
    char *test_name = "deserialize_command(): should_fail_bad_streams";
    // start the test
    TEST_START(test_name);
    // initialize required variables for testing
    Command *cmd_struct;
...
{
    char *test_name = "serialize_response(): should_serialize_response";
    TEST_START(test_name);
    Response *rsp;
...
{
    char *test_name = "serialize_response(): should_serialize_null_byte_response_message";
    TEST_START(test_name);
    Response *rsp;
