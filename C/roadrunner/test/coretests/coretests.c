...
{
    char *test_name = "checkin_command(): should_provide_checkin_response";
...
{
    char *test_name = "sleep_command(): should_execute_good_sleep_cmd";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
    char *command = "sleep";
...
{
    char *test_name = "sleep_command(): should_error_on_bad_sleep_args";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
