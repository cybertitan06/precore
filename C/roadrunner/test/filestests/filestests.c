...
{
    char *test_name = "read_file(): should_read_good_file";
...
{
    char *test_name = "read_file(): should_error_read_on_bad_file";
    TEST_START(test_name)
...
{
    char *test_name = "write_file(): should_write_file";
    TEST_START(test_name)
...
{
    char *test_name = "write_file(): should_error_on_write_null";
    TEST_START(test_name)
    char *file_name = "./test/data/test_write_file.txt";
    uint32_t expected_size = 0;
    uint32_t received_size;
...
{
    char *test_name = "download_file_command(): should_provide_download_response";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
    int good_ret_code = 0;
...
{
    char *test_name = "download_file_command(): should_error_on_bad_download_file_name";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
...
{
    char *test_name = "upload_file_command(): should_provide_upload_response";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
    int good_ret_code = 0;
...
{
    char *test_name = "upload_file_command(): should_error_on_bad_upload_file_name_length";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
    int error_ret_code = 1;
...
{
    char *test_name = "upload_file_command(): should_error_on_bad_upload_content_length";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
    int error_ret_code = 1;
