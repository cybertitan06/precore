...
{
    char *test_name = "hostname_command(): should_provide_hostname_response";
...
{
    char *test_name = "hostname_command(): should_error_failed_hostname";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
    char *command = "hostname";
...
{
    char *test_name = "process_list_command(): should_error_fail_process_list";
    TEST_START(test_name)
    Command *cmd = NULL;
    Response *rsp = NULL;
...
{
    char *test_name = "process_list_command(): should_provide_valid_process_list";
...
{
    char *test_name = "get_netstat_command(): should_error_fail_netstat";
    TEST_START(test_name);
    Command *cmd = NULL;
    Response *rsp = NULL;
...
{
    char *test_name = "get_netstat_command(): should_provide_valid_netstat";
    TEST_START(test_name);
    Command *cmd = NULL;
    Response *rsp = NULL;
    char *command = "netstat";
...
{
    char *test_name = "invoke_command(): should_provide_valid_cmd_return";
    TEST_START(test_name);
    Command *cmd = NULL;
    Response *rsp = NULL;
    char *command = "invoke";
...
{
    char *test_name = "invoke_command(): should_touch_file_with_invoke";
    TEST_START(test_name);
    Command *cmd = NULL;
    Response *rsp = NULL;
    char *command = "invoke";
